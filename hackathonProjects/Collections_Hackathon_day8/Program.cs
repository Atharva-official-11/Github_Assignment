                ...
                switch (choice)
                {
                    case "1":
                        try
                        {
                            ...
                            Policy policy = new Policy(policyID, holderName, type, startDate, endDate);
                    ...
                    case "5":
                        try
                        {
                            ...
                            {
                                repository.DeletePolicyById(policyID);
                    ...
                    case "6":
                        try
                        {
                            var activePolicies = repository.GetActivePolicies();
